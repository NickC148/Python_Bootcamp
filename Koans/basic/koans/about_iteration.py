...
class AboutIteration(Koan):
    ...
    def test_reduce_will_blow_your_mind(self):
        ...
        # Instead of having to call the add or multiply function multiple times, reduce
        # does that for you, so you only need to specify the all the values and do the function
        # call once, yes?
    # ------------------------------------------------------------------
