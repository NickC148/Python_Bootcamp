...
# list.index(x)Return the index in the list of the first item whose value is x. It is an error
# if there is no such item.

# list.count(x)Return the number of times x appears in the list.

# list.sort(cmp=None, key=None, reverse=False)Sort the items of the list in place (the arguments
